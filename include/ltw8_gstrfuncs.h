// ltw8_gstrfuncs.h: ASCII and string-functions header for the 
// ltw8 UTF-8 library.
// New code copyright (c) Chris White, 2016.

#ifndef LTW8_GSTRFUNCS_H_
#define LTW8_GSTRFUNCS_H_
...
// end from glib/glib/gstrfuncs.h

#endif // LTW8_GSTRFUNCS_H_
