// ltw8_unicode_enums.h: C++ enums for Unicode in the ltw8 UTF-8 library.
...
// Note: per glibmm/glib/src/unicode.hg,
// _WRAP_ENUM is used to strip the G_ prefix on the enum values.
...
namespace ltw8 
{
#include "ltw8_unicode_enums_cpp_generated.h"
  // generated by cat ltw8_unicode_enums.h | ../tools/wrap-enum.sh
} // namespace ltw8

#endif // LTW8_UNICODE_ENUMS_
