// ustring.h: ltw8 UTF-8 library string class header
...
#include <sstream>
#include <string>
#ifndef LTW8_HAVE_STD_ITERATOR_TRAITS
...
#endif /* LTW8_HAVE_STD_ITERATOR_TRAITS */
...
public:
...
#ifndef LTW8_HAVE_SUN_REVERSE_ITERATOR
...
#endif /* LTW8_HAVE_SUN_REVERSE_ITERATOR */

#ifdef LTW8_HAVE_ALLOWS_STATIC_INLINE_NPOS
  static LTW8_API const size_type npos = std::string::npos;
#else
  ...
  static LTW8_API const size_type npos;
#endif
...
#ifdef LTW8_HAVE_STD_ITERATOR_TRAITS
