...
dnl  ltw8::Variant specializations for fundamental types
dnl
...
/** Specialization of ltw8::Variant containing a $1 type.
 * @newin{2,26}
 * @ingroup Variant
 */
template <>
...
public:
  ...
  /** Creates a new ltw8::Variant<$1>.
   * @param data The value of the new ltw8::Variant<$1>.
   * @return The new ltw8::Variant<$1>.
   */
  static Variant<$1> create($1 data);
ifelse($4,,,[
  /** Creates a new ltw8::Variant<$1> of type VARIANT_TYPE_[]UPPER($4).
   * @param data The value of the new ltw8::Variant<$1>.
   * @return The new ltw8::Variant<$1>.
   */
  static Variant<$1> create_$4($1 data);
])
  /** Gets the value of the ltw8::Variant<$1>.
   * @return The $1 value of the ltw8::Variant<$1>.
   */
  $1 get() const;
};
])
