...
dnl  ltw8::Value specializations for fundamental types
dnl
...
/**** ltw8::Value<$1> translit(format([%]eval(57-len([$1]))[s],[****/]),[ ],[*])
...
GParamSpec* Value<$1>::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
      ltw8::PARAM_READWRITE);
}

GParamSpec* Value<$1>::create_param_spec(const ltw8::ustring& name, const ltw8::ustring& nick,
