  ...
  const char* custom_type_name, const interface_class_vector_type& interface_classes) const
{
  ...
  ltw8::append_canonical_typename(full_name, custom_type_name);
...
Class::custom_class_init_function(void* g_class, void* class_data)
{
  ...
  gobject_class->get_property = &ltw8::custom_get_property_callback;
  gobject_class->set_property = &ltw8::custom_set_property_callback;
