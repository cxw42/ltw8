...
public:
  ...
  SignalProxyProperty(ltw8::ObjectBase* obj, const gchar* property_name);
...
protected:
  void set_property_(const ltw8::ValueBase& value);
  void get_property_(ltw8::ValueBase& value) const;
...
public:
   ...
   * @newin{2,48}
   */
  sigc::connection connect_changed(const ltw8::ustring& property_name);
