...
/** This is the base class for ltw8::Object properties.
 *
...
public:
   ...
   */
  ltw8::ustring get_name() const;

  /** Returns the nickname of the property.
   */
  ltw8::ustring get_nick() const;

  /** Returns the short description of the property.
   */
  ltw8::ustring get_blurb() const;
...
protected:
   ...
   */
  PropertyBase(ltw8::Object& object, GType value_type);
  ~PropertyBase() noexcept;

  /**
   * Checks if the property has already been installed.
   */
  bool lookup_property(const ltw8::ustring& name);
...
private:
  ...
  friend void ltw8::custom_get_property_callback(
    GObject* object, unsigned int property_id, GValue* value, GParamSpec* param_spec);

  friend void ltw8::custom_set_property_callback(
    GObject* object, unsigned int property_id, const GValue* value, GParamSpec* param_spec);

#endif /* DOXYGEN_SHOULD_SKIP_THIS */
};

/** A ltw8::Object property.
 *
 * This class wraps a GObject property, providing a C++ API to the GObject property
 * system, for use with classes derived from ltw8::Object or ltw8::Interface.
 *
 ...
 * Because of internal implementation, flags shouldn't be set to values: ltw8::PARAM_STATIC_NAME,
 * ltw8::PARAM_STATIC_NICK, ltw8::PARAM_STATIC_BLURB, ltw8::PARAM_CONSTRUCT and
 * ltw8::PARAM_CONSTRUCT_ONLY.
 *
 * The class information must be installed into the GObject system once per
 * property, but this is handled automatically.
 *
 * Each property belongs to an object, inheriting from ltw8::Object.
 * A reference to the object must be passed to the constructor of the property.
 *
 * Each instance of a ltw8::Object-derived type must construct the same properties
 ...
 * However, your constructor must call the ltw8::ObjectBase constructor with a new GType name,
 ...
 *   MyCellRenderer()
 *   :
 *   ltw8::ObjectBase (typeid(MyCellRenderer)),
 *   Gtk::CellRenderer(),
 ...
 *
 *   // ltw8::Property<> can be public,
 *   ltw8::Property<bool> property_mybool;
 *   // or private, and combined with ltw8::PropertyProxy<>.
 *   ltw8::PropertyProxy<int> property_myint() { return property_myint_.get_proxy(); }
 *
 * private:
 *   ltw8::Property<int> property_myint_;
 * };
 * @endcode
 */
template <class T>
...
public:
   ...
   */
  Property(ltw8::Object& object, const ltw8::ustring& name);

  /** Constructs a property of the @a object with the specified @a name and @a default_value.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value);

  /** Constructs a property of the @a object with the specified @a name, @a nick, @a blurb and
   * @a flags.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property(ltw8::Object& object, const ltw8::ustring& name, const ltw8::ustring& nick,
           const ltw8::ustring& blurb, ltw8::ParamFlags flags);
   ...
   */
  Property(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value,
           const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags);
   ...
   */
  inline ltw8::PropertyProxy<T> get_proxy();
};
...
public:
  ...
  typedef ltw8::Value<T> ValueType;

  /**  Constructs a property of the @a object with the specified @a name.
   * For each instance of the object, the same property must be constructed with the same name.
   */
  Property_ReadOnly(ltw8::Object& object, const ltw8::ustring& name);

  /** Constructs a property of the @a object with the specified @a name and @a default_value.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property_ReadOnly(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value);

  /** Constructs a property of the @a object with the specified @a name, @a nick, @a blurb and
   * @a flags.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property_ReadOnly(ltw8::Object& object, const ltw8::ustring& name, const ltw8::ustring& nick,
           const ltw8::ustring& blurb, ltw8::ParamFlags flags);
  ...
  /** Returns a proxy object that can be used to manipulate this property.
   */
  inline ltw8::PropertyProxy_ReadOnly<T> get_proxy();
};
...
public:
   ...
   * For each instance of the object, the same property must be constructed with the same name.
   */
  Property_WriteOnly(ltw8::Object& object, const ltw8::ustring& name);

  /** Constructs a property of the @a object with the specified @a name and @a default_value.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property_WriteOnly(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value);

  /** Constructs a property of the @a object with the specified @a name, @a nick, @a blurb and
   * @a flags.
   * For  each instance of the object, the same property must be constructed with the same name.
   */
  Property_WriteOnly(ltw8::Object& object, const ltw8::ustring& name, const ltw8::ustring& nick,
           const ltw8::ustring& blurb, ltw8::ParamFlags flags);
  ...
  /** Returns a proxy object that can be used to manipulate this property.
   */
  inline ltw8::PropertyProxy_WriteOnly<T> get_proxy();
};
...
template <class T>
Property<T>::Property(ltw8::Object& object, const ltw8::ustring& name)
: Property(object, name, ltw8::ustring(), ltw8::ustring(), ltw8::PARAM_READWRITE)
{
}
...
: Property(object, name, default_value, ltw8::ustring(),
    ltw8::ustring(), ltw8::PARAM_READWRITE)
{
}
...
template <class T>
Property<T>::Property(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value,
           const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags)
:
  PropertyBase(object, ValueType::value_type())
{
...
template <class T>
inline ltw8::PropertyProxy<T>
Property<T>::get_proxy()
{
  return ltw8::PropertyProxy<T>(object_, get_name_internal());
}

/**** ltw8::Property_ReadOnly<T> ****************************************************/

template <class T>
Property_ReadOnly<T>::Property_ReadOnly(ltw8::Object& object, const ltw8::ustring& name)
: Property_ReadOnly(object, name, ltw8::ustring(), ltw8::ustring(), ltw8::PARAM_READABLE)
{
}
...
: Property_ReadOnly(object, name, default_value, ltw8::ustring(), ltw8::ustring(),
    ltw8::PARAM_READABLE)
{
}
...
: PropertyBase(object, ValueType::value_type())
{
  flags |= ltw8::PARAM_READABLE;
  flags &= ~ltw8::PARAM_WRITABLE;
...
template <class T>
Property_ReadOnly<T>::Property_ReadOnly(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value,
           const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags)
: PropertyBase(object, ValueType::value_type())
{
  flags |= ltw8::PARAM_READABLE;
...
template <class T>
inline ltw8::PropertyProxy_ReadOnly<T>
Property_ReadOnly<T>::get_proxy()
{
  return ltw8::PropertyProxy_ReadOnly<T>(object_, get_name_internal());
}

/**** ltw8::Property_WriteOnly<T> ****************************************************/

template <class T>
Property_WriteOnly<T>::Property_WriteOnly(ltw8::Object& object, const ltw8::ustring& name)
: Property_WriteOnly(object, name, ltw8::ustring(),
    ltw8::ustring(), ltw8::PARAM_WRITABLE)
{
}
...
: Property_WriteOnly(object, name, default_value, ltw8::ustring(),
    ltw8::ustring(), ltw8::PARAM_WRITABLE)
{
}
...
template <class T>
Property_WriteOnly<T>::Property_WriteOnly(ltw8::Object& object, const ltw8::ustring& name, const PropertyType& default_value,
           const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags)
: PropertyBase(object, ValueType::value_type())
{
  flags |= ltw8::PARAM_WRITABLE;
...
template <class T>
inline ltw8::PropertyProxy_WriteOnly<T>
Property_WriteOnly<T>::get_proxy()
{
  return ltw8::PropertyProxy_WriteOnly<T>(object_, get_name_internal());
}
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
