#ifndef LTW8_SIGNALPROXY_H_
#define LTW8_SIGNALPROXY_H_
...
{
public:
  SignalProxyBase(ltw8::ObjectBase* obj);
...
protected:
   ...
   * be called by glib.
   */
  SignalProxyNormal(ltw8::ObjectBase* obj, const SignalProxyInfo* info);
...
protected:
   ...
   */
  SignalProxyDetailed(
    ltw8::ObjectBase* obj, const SignalProxyInfo* info, const ltw8::ustring& detail_name);
...
private:
  ...
  const ltw8::ustring detailed_name_; // signal_name[::detail_name]
...
public:
  ...
  SignalProxyDetailedAnyType(
    ObjectBase* obj, const SignalProxyInfo* info, const ltw8::ustring& detail_name)
