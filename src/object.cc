...
// so:
// ltw8::WeakRef<SomeDerivedObject> weakrefSomeObject(object1);
// ...
...
ConstructParams::ConstructParams(const ltw8::Class& glibmm_class_)
...
ConstructParams::ConstructParams(
  const ltw8::Class& glibmm_class_, const char* first_property_name, ...)
: glibmm_class(glibmm_class_), n_parameters(0), parameters(nullptr)
{
  va_list var_args;
  ...
  for (const char* name = first_property_name; name != nullptr; name = va_arg(var_args, char*))
  {
    ...
    if (!pspec)
    {
      g_warning("ltw8::ConstructParams::ConstructParams(): "
    ...
    if (collect_error)
    {
      g_warning("ltw8::ConstructParams::ConstructParams(): %s", collect_error);
...
Object::Object()
{
  ...
  // If ltw8::ObjectBase has been constructed with a custom typeid, we derive
  ...
  // Connect the GObject and ltw8::Object instances.
  ObjectBase::initialize(static_cast<GObject*>(new_object));
}

Object::Object(const ltw8::ConstructParams& construct_params)
{
...
Object::Object(GObject* castitem)
{
  ...
  /*
    ...
    {
      g_warning("ltw8::Object::Object(GObject*): "
                "An object of type '%s' was created directly via g_object_new(). "
                "The Object::Object(const ltw8::ConstructParams&) constructor "
