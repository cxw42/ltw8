#ifndef LTW8_REFPTR_H_
#define LTW8_REFPTR_H_
 ...
 * In gtkmm, that is anything derived from ltw8::ObjectBase, such as
 * Gdk::Pixmap.
 *
...
private:
  ...
  /** Helper class for disallowing use of ltw8::RefPtr with certain classes.
   *
   * Disallow for instance in Gtk::Widget and its subclasses.
   * ltw8::RefPtr<T>::is_allowed_type::value is false if
  ...
  static_assert(is_allowed_type::value, "ltw8::RefPtr must not be used with this class.");
