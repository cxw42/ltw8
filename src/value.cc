...
GParamSpec*
ValueBase_Boxed::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
    static_cast<ltw8::ParamFlags>(G_PARAM_READABLE | G_PARAM_WRITABLE));
}

GParamSpec* ValueBase_Boxed::create_param_spec(const ltw8::ustring& name,
  const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags) const
{
...
void
ValueBase_Object::set_object(ltw8::ObjectBase* data)
{
...
ValueBase_Object::get_object() const
{
  ...
  return ltw8::wrap_auto(data, false);
}

ltw8::RefPtr<ltw8::ObjectBase>
ValueBase_Object::get_object_copy() const
{
  GObject* const data = static_cast<GObject*>(g_value_get_object(&gobject_));
  return ltw8::RefPtr<ltw8::ObjectBase>(ltw8::wrap_auto(data, true));
}

GParamSpec*
ValueBase_Object::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
      static_cast<ltw8::ParamFlags>(G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
GParamSpec*
ValueBase_Object::create_param_spec(const ltw8::ustring& name,
  const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags) const
{
  // ltw8::Value_Pointer<> derives from ltw8::ValueBase_Object, because
  // we don't know beforehand whether a certain type is derived from
  // ltw8::Object or not.  To keep create_param_spec() out of the template
...
GParamSpec*
ValueBase_Enum::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
      static_cast<ltw8::ParamFlags>(G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
GParamSpec*
ValueBase_Enum::create_param_spec(const ltw8::ustring& name,
  const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags) const
{
...
GParamSpec*
ValueBase_Flags::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
      static_cast<ltw8::ParamFlags>(G_PARAM_READABLE | G_PARAM_WRITABLE));
}

GParamSpec* ValueBase_Flags::create_param_spec(const ltw8::ustring& name,
  const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags) const
{
...
GParamSpec*
ValueBase_String::create_param_spec(const ltw8::ustring& name) const
{
  return create_param_spec(name, ltw8::ustring(), ltw8::ustring(),
      static_cast<ltw8::ParamFlags>(G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
GParamSpec*
ValueBase_String::create_param_spec(const ltw8::ustring& name,
  const ltw8::ustring& nick, const ltw8::ustring& blurb, ltw8::ParamFlags flags) const
{
...
/**** ltw8::Value<ltw8::ustring> *******************************************/

void
Value<ltw8::ustring>::set(const ltw8::ustring& data)
{
  g_value_set_string(&gobject_, data.c_str());
}
