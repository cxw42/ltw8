#ifndef LTW8_OBJECTBASE_H_
#define LTW8_OBJECTBASE_H_
...
/** ltw8::ObjectBase is a common base class for Objects and Interfaces.
 *
...
protected:
  ...
  // Called by ltw8::Object and ltw8::Interface constructors. See comments there.
  void initialize(GObject* castitem);

  // Called by ltw8::Object and ltw8::Interface C++ move operations.
  void initialize_move(GObject* castitem, ltw8::ObjectBase* previous_wrapper);

public:
  /// You probably want to use a specific property_*() accessor method instead.
  void set_property_value(const ltw8::ustring& property_name, const ltw8::ValueBase& value);

  /// You probably want to use a specific property_*() accessor method instead.
  void get_property_value(const ltw8::ustring& property_name, ltw8::ValueBase& value) const;

  /// You probably want to use a specific property_*() accessor method instead.
  template <class PropertyType>
  void set_property(const ltw8::ustring& property_name, const PropertyType& value);

  /// You probably want to use a specific property_*() accessor method instead.
  template <class PropertyType>
  void get_property(const ltw8::ustring& property_name, PropertyType& value) const;
   ...
   */
  void connect_property_changed(const ltw8::ustring& property_name, const sigc::slot<void>& slot);

  /** You can use the signal_changed() signal of the property proxy instead.
   *
   * @newin{2,48}
   */
  void connect_property_changed(const ltw8::ustring& property_name, sigc::slot<void>&& slot);
  ...
  // I wrapped GBinding in ltw8::Binding. /Kjell
  ...
  //  if(object)
  //    return static_cast<ObjectBase*>(g_datalist_id_get_data(&object->qdata, ltw8::quark_));
  //  else
  //    return 0;
  //}
...
protected:
  ...
  void _move_current_wrapper(GObject* object, ltw8::ObjectBase* previous_wrapper) noexcept;
#endif // DOXYGEN_SHOULD_SKIP_THIS
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  friend class ltw8::GSigConnectionNode; // for GSigConnectionNode::notify()
#endif
};
...
template <class PropertyType>
inline void
ObjectBase::set_property(const ltw8::ustring& property_name, const PropertyType& value)
{
  ltw8::Value<PropertyType> property_value;
  property_value.init(ltw8::Value<PropertyType>::value_type());
...
template <class PropertyType>
inline void
ObjectBase::get_property(const ltw8::ustring& property_name, PropertyType& value) const
{
  ltw8::Value<PropertyType> property_value;
  property_value.init(ltw8::Value<PropertyType>::value_type());
