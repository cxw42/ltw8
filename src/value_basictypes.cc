...
GParamSpec* Value<bool>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<char>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<signed char>::create_param_spec(const ltw8::ustring& name) const
{
  return g_param_spec_char(
      name.c_str(), 0, 0,
...
GParamSpec* Value<unsigned char>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<int>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<unsigned int>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<long>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<unsigned long>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<long_long>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<unsigned_long_long>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<float>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<double>::create_param_spec(const ltw8::ustring& name) const
{
...
GParamSpec* Value<void*>::create_param_spec(const ltw8::ustring& name) const
{
